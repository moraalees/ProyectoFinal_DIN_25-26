...
fun FilaMarcaEjercicio(
    ...
    Surface(
        ...
        Row(
            ...
            Column {
                Text(text = marca.nombreEjercicio, style = MaterialTheme.typography.titleMedium)
                Spacer(modifier = Modifier.height(4.dp))
                Text(text = "${marca.pesoMaximo ?: "—"} kg · ${marca.repeticionesMaximas ?: "—"} rep", style = MaterialTheme.typography.bodyMedium)
            }
